...
class Request:
    ...
    def _request_wrapper(self, *args: object, **kwargs: Any) -> bytes:
        ...
        except integration_utils.vendors.telegram.vendor.ptb_urllib3.urllib3.exceptions.TimeoutError as error:
            raise TimedOut() from error
        except integration_utils.vendors.telegram.vendor.ptb_urllib3.urllib3.exceptions.HTTPError as error:
